...
const Carousel = ({ images, interval = 6000 }) => {
  ...
  return (
    <div className="relative w-auto  md:w-full h-auto md:h-[80vh] overflow-hidden">
      <div
          ...
          <div key={i} className="relative shrink-0 w-full">
            ...
            {i === index && (
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center bg-gradient-to-t from-black/70 via-black/40 to-transparent">
                <h1 className="font-extrabold text-amber-400 text-xl sm:text-5xl md:text-7xl uppercase animate-fadeInUp">
                  {obj.name}
                </h1>
              </div>
            )}
      ...
      <button
        ...
        text-white text-xl sm:text-3xl p-2 bg-white/20 backdrop-blur-md rounded-full 
